...
public final class Constants {
    public static final String RIGHT_CLICK_ITEMS_PREFIX = "right-click-items.";
    public static final String COOLDOWN_MILLIS = "cooldown-millis";
    public static final String FLY_RESTORE_ON_WORLD_CHANGE = "fly.restore-on-world-change";
